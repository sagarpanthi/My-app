        ...
        return(
            ...
            <Card style={{ width: '25rem', marginTop:50, marginLeft:50 }} >
                ...
                <Card.Body>
                    ...
                    <Button style={{color:"black",backgroundColor:"#FED250",borderColor:"#B32121", marginTop:5, marginRight:80}} variant="primary" onClick={(event => this.props.hitThisProduct())}>Book</Button>
                    {/*<Box paddingTop={1} />*/}
